...
Voici les données:https://s3.eu-west-1.amazonaws.com/course.oc-static.com/projects/DAN_V1_P9/data_conso.zip. 
Ce sont les données journalières et non mensuelles, donc vous les devrez recompiler en données mensuelles.
